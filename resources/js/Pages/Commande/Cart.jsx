            ...
            {isCartOpen && (
                ...
                >
                    <motion.div
                        ...
                        exit={{ y: -50, opacity: 0 }}
                        className="bg-white dark:bg-gray-800 rounded-lg h-[700px] overflow-hidden shadow-lg w-full max-w-4xl mx-4 relative"
                    ...
                    >
                        ...
                        {/* Scrollable Content */}
                        <div className="overflow-y-auto h-[calc(100%-200px)] p-10">
